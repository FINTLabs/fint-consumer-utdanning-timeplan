...
public class LinkMapper {
    ...
    public static Map<String, String> linkMapper(String contextPath) {
        return ImmutableMap.<String,String>builder()
            ...
            .put("no.novari.fint.model.utdanning.elev.Elevtilrettelegging", "/utdanning/elev/elevtilrettelegging")
            .put("no.novari.fint.model.utdanning.utdanningsprogram.Programomrade", "/utdanning/utdanningsprogram/programomrade")
            .put("no.novari.fint.model.utdanning.kodeverk.Skolear", "/utdanning/kodeverk/skolear")
            .put("no.novari.fint.model.utdanning.kodeverk.Fagmerknad", "/utdanning/kodeverk/fagmerknad")
            .put("no.novari.fint.model.utdanning.kodeverk.Fagstatus", "/utdanning/kodeverk/fagstatus")
            .put("no.novari.fint.model.utdanning.elev.Elevforhold", "/utdanning/elev/elevforhold")
            .put("no.novari.fint.model.utdanning.elev.Varsel", "/utdanning/elev/varsel")
