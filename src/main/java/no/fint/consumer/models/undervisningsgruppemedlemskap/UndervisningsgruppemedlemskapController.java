...
public class UndervisningsgruppemedlemskapController {
    ...
    public UndervisningsgruppemedlemskapResources getUndervisningsgruppemedlemskap(
        ...
        List<UndervisningsgruppemedlemskapResource> undervisningsgruppemedlemskap;
        if (sinceTimeStamp == null) {
            undervisningsgruppemedlemskap = cacheService.getAll(orgId);
        } else {
            undervisningsgruppemedlemskap = cacheService.getAll(orgId, sinceTimeStamp);
        }

        fintAuditService.audit(event, Status.CACHE_RESPONSE, Status.SENT_TO_CLIENT);

        return linker.toResources(undervisningsgruppemedlemskap);
    }
    ...
    public UndervisningsgruppemedlemskapResource getUndervisningsgruppemedlemskapBySystemId(
        ...
        if (cacheService != null) {
            ...
            return linker.toResource(undervisningsgruppemedlemskap);
        }    
    }
